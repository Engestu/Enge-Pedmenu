-- Volitelný globální seznam všech pedů, které má server považovat za "validní".
-- Pokud nechceš validaci proti seznamu, klidně nech prázdné {} a používej jen AllowedByDiscord.
-- Můžeš sem vložit tvůj dlouhý seznam (např. generovaný), ve tvaru níže.
